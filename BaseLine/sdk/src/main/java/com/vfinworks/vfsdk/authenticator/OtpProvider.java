...
import com.vfinworks.vfsdk.authenticator.AccountDb.OtpType;
import com.vfinworks.vfsdk.authenticator.PasscodeGenerator.Signer;
...
public class OtpProvider implements OtpSource {
  ...
  public String computeToTpPin(String secret, byte[] challenge)
          throws OtpSourceException {
    long  otp_state = mTotpCounter.getValueAtTime(Utilities.millisToSeconds(mTotpClock
            .currentTimeMillis()));
