...
public class TotpClock implements SharedPreferences.OnSharedPreferenceChangeListener {
  ...
  public long currentTimeMillis() {
    long systemTime= SharedPreferenceUtil.getInstance().getLongValueFromSP(SharedPreferenceUtil.TIME)+ SystemClock.elapsedRealtime();
    return systemTime + getTimeCorrectionMinutes() * Utilities.MINUTE_IN_MILLIS;
  }
